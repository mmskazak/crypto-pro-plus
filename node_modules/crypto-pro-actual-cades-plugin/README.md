...
```html
<script src="crypto-pro-actual-cades-plugin/dist/crypto-pro-actual-cades-plugin.min.js"></script>
<script>
...
```typescript
import { getUserCertificates, Certificate } from 'crypto-pro-actual-cades-plugin';
