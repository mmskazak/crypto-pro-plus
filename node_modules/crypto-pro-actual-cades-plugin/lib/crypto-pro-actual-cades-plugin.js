...
/******/ 	return __webpack_require__(__webpack_require__.s = "./crypto-pro-actual-cades-plugin.ts");
/******/ })
/************************************************************************/
/******/ ({
...
exports._afterPluginsLoaded = (fn) => {
    ...
    return function (...args) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!isPluginLoaded) {
                try {
                    __webpack_require__(/*! cadesplugin_api.js-actual */ "../node_modules/cadesplugin_api.js-actual/dist/cadesplugin_api.js");
                }
                catch (error) {
                    console.error(error);
...
//# sourceMappingURL=crypto-pro-actual-cades-plugin.js.map