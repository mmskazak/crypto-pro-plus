...
/* Подтягиваем «обёртку» плагина прямо из CDN.
   Она создаст Promise window.cadesplugin.                  */
   import "https://cdn.jsdelivr.net/npm/crypto-pro-actual-cades-plugin@2.4.1/cadesplugin_api.js";

   /* Подсказываем TypeScript’у, что в window появится cadesplugin */
   declare global {
